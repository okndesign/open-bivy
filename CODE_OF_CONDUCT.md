...
Specific to this project — given its social context (homelessness, people without permanent housing):

- Demeaning, stigmatizing, or dismissive statements about people without permanent housing will not be tolerated
- Discussion of the topic is welcome, but must stay respectful and on-topic — general political debates unrelated to the project don't belong in issues
...
This Code of Conduct applies within all community spaces (issues, pull requests, discussions), and also applies when an individual is officially representing the project in public spaces (e.g. via an official project social media account).

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to: **[contact details to be added]**
...
This Code of Conduct is adapted from the [Contributor Covenant](https://www.contributor-covenant.org), version 2.1, with a project-specific addition addressing the social context of this project.
